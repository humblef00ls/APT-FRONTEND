...
<script>
	...
	import { lightMode,mainTitle,url} from './stores.js';
...
import { onMount } from 'svelte';
	...
	onMount(() => {
		...
		$lightMode = JSON.parse(window.localStorage.getItem('lightMode')) ?? !(window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches)
...
<svg class="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 153.82 179.19"
	><g id="Layer_2" data-name="Layer 2"
		><g id="Layer_1-2" data-name="Layer 1"
			><polygon points="109.3 27.67 124.08 27.67 124.08 13.77 109.3 13.86 109.3 27.67" /><path
			...
			/><path d="M138,1.86v12s10,0,15.78-.66l.08-12.5C151,1.1,138,1.86,138,1.86Z" /><path
