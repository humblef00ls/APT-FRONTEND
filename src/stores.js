...
//let fgs = aptsX.map((λ,i) => {let Σ = {} ; Σ.name = λ.filename; Σ.initial = λ.initial ;return Σ} )




export const editorValues = writable(JSON.parse(localStorage.getItem('editorValues')) ?? aptsX.reduce( (Σ,λ) => {Σ[λ.filename] = λ.initial; return Σ},{}) );
